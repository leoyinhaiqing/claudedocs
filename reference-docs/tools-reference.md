...
| `CronCreate`           | Schedules a recurring or one-shot prompt within the current session                                                         | No                  |
...
| `LSP`                  | Code intelligence via language servers. Reports type errors and warnings automatically after file edits                     | No                  |
...
| `TodoWrite`            | Manages the session task checklist. Available in non-interactive mode and Agent SDK                                         | No                  |
